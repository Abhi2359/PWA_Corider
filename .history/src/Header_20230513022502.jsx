  ...
  return (
    ...
    <div className="header">
        ...
        <div className="trip_details">
            <div className="user_icon" style={{backgroundImage:"url('https://fastly.picsum.photos/id/1072/160/160.jpg?hmac=IDpbpA5neYzFjtkdFmBDKXwgr-907ewXLa9lLk9JuA8')"}}>Image</div>
